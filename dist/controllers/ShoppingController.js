    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (result.length > 0) {
                    foodResult_2 = [];
                    result.filter(function (item) { return foodResult_2.push.apply(foodResult_2, item.foods); });
...
var RestaurantsById = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
