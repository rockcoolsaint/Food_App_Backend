...
var CreateVendor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, address, pincode, foodType, email, password, ownerName, phone, existingVendor, salt, userPassword, createdVendor;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (existingVendor !== null) {
                    return [2 /*return*/, res.json({ "message": "A vendor already exists with this email ID" })];
                }
            ...
            case 4:
                ...
                return [2 /*return*/, res.json(createdVendor)];
        }
    });
}); };
