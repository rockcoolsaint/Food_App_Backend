...
export const DeliverySignUp = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const deliveryUserInputs = plainToClass(DeliveryUser, req.body);
...
export const DeliveryLogin = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const loginInputs = plainToClass(DeliveryUser, req.body);
...
export const EditDeliveryUserProfile = async (req: Request, res: Response, next: NextFunction) => {
    ...
    const customerInputs = plainToClass(DeliveryUser
      , req.body);
...
export const UpdateDeliveryUserStatus = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(400).json({ msg: 'Error while Updating Status'});
